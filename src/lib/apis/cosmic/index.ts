...
export const getRAGTemplate = async (token: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/template`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getQuerySettings = async (token: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/query/settings`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const updateQuerySettings = async (token: string, settings: QuerySettings) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/query/settings/update`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getEmbeddingConfig = async (token: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/embedding`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const updateEmbeddingConfig = async (token: string, payload: EmbeddingModelUpdateForm) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/embedding/update`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getRerankingConfig = async (token: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/reranking`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const updateRerankingConfig = async (token: string, payload: RerankingModelUpdateForm) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/reranking/update`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const processFile = async (
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/process/file`, {
		method: 'POST',
		headers: {
...
export const processYoutubeVideo = async (token: string, url: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/process/youtube`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const processWeb = async (token: string, collection_name: string, url: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/process/web`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const processWebSearch = async (
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/process/web/search`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const queryDoc = async (
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/query/doc`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const queryCollection = async (
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/query/collection`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const resetUploadDir = async (token: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/reset/uploads`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			authorization: `Bearer ${token}`
...
export const resetVectorDB = async (token: string) => {
	...
	const res = await fetch(`${COSMIC_API_BASE_URL}/reset/db`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			authorization: `Bearer ${token}`
